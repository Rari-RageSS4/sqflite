...
class AddstudentDesktop extends StatefulWidget {
  const AddstudentDesktop({super.key});
      ...
      child: Form(
        ...
        child: Column(mainAxisSize: MainAxisSize.max, children: [
          Container(
            ...
            child: Image.network(
                'https://purepng.com/public/uploads/large/purepng.com-ninjashinobininjacovert-agentassassinationguerrilla-warfaresamuraiclip-art-1421526960633owjjy.png'),
          ),
          const SizedBox(
            height: 20,
          ),
